...
AXON_COMMANDS: dict[str, str] = {
    ...
    "/artifacts": "List and view project artifacts — /artifacts | /artifacts view <filename>",
    ...
    "/setup": "Guided wizard — provider, API key, security mode, Telegram/GitHub/Discord/Slack",
    "/config": "Runtime policy — /config | /config set <key> <value>",
    "/provider": "LLM provider — /provider | /provider custom <url> <key>",
    "/autopilot": "Autopilot full autonomy — /autopilot on|off|status (admin)",
    ...
    "/mcp": "MCP servers — /mcp list | /mcp add [--temp] <name> <cmd...> | /mcp remove <name>",
